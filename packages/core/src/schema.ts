...
export interface ConnectorStrategy {
  ...
  isSelectableAppIntegration?(
    integration: ConnectorAppIntegration
  ): boolean | Promise<boolean>;
  buildAuthorizationUrl(
    input: ConnectorAuthorizationUrlInput
  ): Promise<ConnectorAuthorizationUrlResult>;
  ...
  pollAuthorization?(
    input: ConnectorAuthorizationPollInput
  ): Promise<ConnectorAuthorizationPollResult>;
}
